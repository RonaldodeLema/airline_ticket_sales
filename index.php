...
if (!isset($_SESSION['all_src'])) {
   header("Location: api/get-all-des-src.php");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="main-layout">
                        ...
                        <form action="user/index.php" method="post" id="form-search-flight">
                           ...
                           <div class="mb-4 form-group d-sm-flex margin text-light">
                              <div
                                 ...
                                 <input type="text" name="source" required placeholder="Điểm đi" id="from"
                                    class="form-control" style="background-color:#000000c7;border: 0;color: white;" list="src">
                                 <datalist id="src">
                                    <?php
                              ...
                              <div
                                 ...
                                 <input type="text" name="destination" required placeholder="Điểm đến" id="to"
                                    class="form-control" style="background-color:#000000c7;border: 0;color: white;" list="des">
                                    <datalist id="des">
                                    <?php
   ...
   <script>
      ...
      // let city = ['Hà Nội', 'TP Hồ Chí Minh', 'Đà Nẵng',
      //    'Quảng Ninh', 'Hải Phòng', 'Nghệ An', 'Huế', 'Khánh Hòa',
      //    'Lâm Đồng', 'Bình Định', 'Cần Thơ', 'Kiên Giang', 'Điện Biên',
      //    'Thanh Hóa', 'Quảng Bình', 'Quảng Nam', 'Phú Yên', 'Gia Lai',
      //    'Đắk Lăk', 'Kiên Giang', 'Cà Mau', 'Bà Rịa - Vũng Tàu']
      // $("#from").autocomplete({
      //    source: city
      // });
      // $("#to").autocomplete({
